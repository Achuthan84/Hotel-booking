    ...
    return (
        <div className='md:w-64 w-16 border-r h-full text-base border-gray-400 pt-4 flex flex-col transition-all duration-300'>
            {sideBarLinks.map((items, index) => (
                ...
                className={({ isActive }) => `flex items-center py-3 px-4 md:px-8 gap-3 ${isActive ? 'border-r-4 md:border-r-[4px] bg-blue-600/30 border-blue-600 text-blue-600' : 'hover:bg-gray-300/90 border-white text-gray-700'}`}>
